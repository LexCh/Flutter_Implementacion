  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(widget.edit?"Editar Persona":"Agregar Persona"),),
      body: Form(
        key: _formKey,
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                textFormField(nameEditingController, "Nombre", "Enter Name",
                Icons.person, widget.edit ? widget.client.name : "name"),
                textFormFieldPhone(phoneEditingController, "Telefono", "Enter phone", 
                Icons.phone_android, widget.edit ? widget.client.phone : "phone",),
